...
|---|---|---|
| `ADMIN_PASSWORD` | вхід власника — **зроби довгим/випадковим** (це майстер-ключ) | ⚠️ перевірити |
| `TG_WEBHOOK_SECRET` | тепер ОБОВ'ЯЗКОВИЙ (без нього вебхук = 403) | ⚠️ задати |
| `JWT_SECRET` | підпис токенів — довгий випадковий | ⚠️ перевірити |
| `SUPABASE_URL`, `SUPABASE_SERVICE_KEY` | БД | ✅ задано |
| `TG_TOKEN`, `TG_CHAT_ID`, `TG_BOT_USERNAME` | сповіщення | ✅ задано |
| `MANAGER_PASSWORD` | окремий вхід менеджера (опц., без доступу до грошей) | ⚪ опційно |
| `GOOGLE_SA_KEY_B64` | синк Google Sheets (опц.) | ⚪ опційно |
