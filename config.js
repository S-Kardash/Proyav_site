...
(function () {
  ...
  // Порожні поля (taxId/email) сторінки приховують автоматично — власник додасть згодом.
  var legal = {
    brand:     'ПРОЯВ',
    entity:    'ФОП Кардаш Олександр Юрійович',
    taxId:     '',            // РНОКПП (ІПН) — додати згодом
    email:     '',            // окремий робочий email — додати згодом
    phone:     '+380737679757',
